...
import com.runing.Config.WxPayConfig;
import com.runing.entity.Json;
import com.util.AesCbuUtil;
...
public class H_RuningPayRestful {
    private static Logger log = Logger.getLogger(H_RuningPayRestful.class);
  ...
  Map userdata = (Map) json.getData();
    ...
    public Json createPay(String openid, HttpServletRequest request){
        ...
        try{
            //生成的随机字符串
            String nonce_str = RandomStringUtils.random(32);
            //商品名称
            String body = "测试商品名称";
            //获取本机的ip地址
