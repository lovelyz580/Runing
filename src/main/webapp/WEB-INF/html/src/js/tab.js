...
layui.define(['jquery', 'element', 'nprogress', 'utils'], function(exports) {
    ...
    var _tab = {
        ...
        createTabDom: function() {
            ...
            //模板
            var tpl = [
                    '<div class="layui-tab layui-tab-card kit-tab" lay-filter="' + that._filter + '">', //data-url="' + _config.mainUrl + '">
                    '<ul class="layui-tab-title">',
                    '<li class="layui-this" style="opacity:0;width:0;min-width:0;padding:0;margin:0;z-index:-1" lay-id="-1" <i class="layui-icon"></i></li>',
                    '</ul>',
